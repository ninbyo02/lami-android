...
- artifact: `artifacts/qairt244_npu_turn_stop_quality_compare/20260525_065723`
- device: `192.168.52.52:35199`
...
- `sanitizer_only`: standard hidden run, requested max_output_tokens=128
- `lower_max_tokens_64_sanitizer`: standard hidden run, requested max_output_tokens=64
- `lower_max_tokens_32_sanitizer`: standard hidden run, requested max_output_tokens=32
...
- `max_output_tokens` is passed through the inspected standard hidden receiver extra and capped by this runner at 128 or lower.
