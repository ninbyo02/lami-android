# QAIRT244 NPU max_output_tokens 512 three-prompt code-aware hidden comparison

- artifact: `artifacts/qairt244_npu_max_output_512_three_prompt_codeaware_compare/20260527_014523`
...
| --- | --- | --- | ---: | --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | --- | --- | --- |
| `こんにちは` | `success` | `natural_japanese` | 884 | `success` | `natural_japanese` | `not_applicable` | `not_applicable` | 848 | 2000 | 24 | `true` | `false` | `false` | `false` | `false` |
...
| `ラミィのNPU推論について短く説明して` | `success` | `natural_japanese` | 4110 | `success` | `natural_japanese` | `not_applicable` | `not_applicable` | 3989 | 5000 | 251 | `true` | `false` | `false` | `false` | `false` |
