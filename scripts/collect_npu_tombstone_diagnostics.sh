...
KEYWORDS="FATAL|SIGABRT|Abort message|DEBUG|tombstone|litert|LiteRt|LiteRT|LiteRtDispatch|Dispatch|dispatch|QNN|Qnn|HTP|Htp|NPU|nativeCreateEngine|liblitertlm_jni|libLiteRt|libLiteRtDispatch_Qualcomm|No usable Dispatch runtime found|Failed to initialize Dispatch API|insufficient capabilities|version mismatch|symbol mismatch|LiteRtQualcommOptionsGet|LiteRtDispatchGetApi|QAIRT244_SMOKE|QAIRT244_SENTINEL|QAIRT244_DIAG|qairt244_app_jni_smoke_v1|qairt244_jni_entry_v1|qairt244_android_log_v1"
LIBS=(
