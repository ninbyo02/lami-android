...
KEYWORDS="FATAL|SIGABRT|Abort message|DEBUG|tombstone|litert|LiteRt|LiteRT|LiteRtDispatch|Dispatch|dispatch|QNN|Qnn|HTP|Htp|NPU|nativeCreateEngine|liblitertlm_jni|libLiteRt|libLiteRtDispatch_Qualcomm|No usable Dispatch runtime found|Failed to initialize Dispatch API|insufficient capabilities|version mismatch|symbol mismatch|LiteRtQualcommOptionsGet|LiteRtDispatchGetApi"
LIBS=(
