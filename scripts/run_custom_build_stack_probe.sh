...
EXPECTED_QAIRT244_LOGGING_DISPATCH_BUILD_ID="a1b66b12e643f15a94cb34093f9efcac"
EXPECTED_QAIRT244_LOGGING_LITERTLM_JNI_BUILD_ID="8554bcd057031088ad9bb2100f1f8f94"
EXPECTED_QAIRT244_LOGGING_COMPILER_PLUGIN_BUILD_ID="12a6ac7197aff7045fc5f5c263b35f9f"
...
EXPECTED_QAIRT244_LOGGING_DISPATCH_SHA256="459ceb6e3912fa72b43363c763315b2fbf5d336e744e82e4850f33967c7bbeba"
EXPECTED_QAIRT244_LOGGING_LITERTLM_JNI_SHA256="462d69fbb71a7bb5e2aa74562959885e7d4f647fc92f4725e726039bbae57474"
EXPECTED_QAIRT244_LOGGING_COMPILER_PLUGIN_SHA256="299769ef90f9ee4b74b357bd867545e1f48312bb8b1d97f9d16968a2be175655"
...
adb logcat -b all -d -t 5000 2>/dev/null | grep -Ei "Custom Build Stack|NpuExperimentProbe|AcceleratorProbe|LiteRt|LiteRT|litert|Dispatch|dispatch|QNN|Qnn|HTP|Htp|ADSP|nativeCreateEngine|customnpu|linker|linker64|dlopen|dlerror|dlsym|cannot locate|library .* not found|needed by|namespace|qairt244_dlopen_trace_v1|qairt244_qnn_provider_trace_v1|qairt244_htp_backend_trace_v1|qairt244_htp_log_callback_v1|CheckRuntimeCompatibility|RuntimeCApi|NPU|lami|FATAL|SIGABRT|SIGSEGV" || true
