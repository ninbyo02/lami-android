...
- timestamp: `controlled_accelerator_1024_null_1789208946`
...
- phases: `send-message`
- requested_context_tokens_lists: `1024`
- timeout_ms: `45000`
...
| --- | --- | --- | --- | --- | --- | --- | ---: | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- | --- | --- | ---: | ---: | ---: | --- | --- |
| gallery-chat-parity | GPU | auto | true | normal | send-message | こんにちは | 1024 | 1024 | success | completed | 12424 | 11 | 126 | 126 | 673 | 13122 |  |  | false | false | false | false | gallery_contents_callback | 64 | 0.95 | 1.0 | true | true |
...
- max_output_tokens (legacy context alias): `1024`
- max_output_tokens_list: `1024`
- model_path_source: `auto`
- generic_fallback_model_configured: `true`
- model_path: `/data/user/0/io.github.ninbyo02.lami.gpucontrolled/files/cases/controlled_accelerator_1024_null_1789208946/model.litertlm`
- model_exists: `true`
