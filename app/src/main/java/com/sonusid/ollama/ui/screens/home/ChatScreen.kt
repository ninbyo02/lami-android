...
private val ComposerHorizontalPadding = 17.dp
    ...
    Scaffold(
        ...
        Column(
            ...
            Box(modifier = Modifier.fillMaxWidth()) {
                ...
                val sideGutterBrush = Brush.verticalGradient(
                    colors = listOf(
                        gutterColor.copy(alpha = 0f),
                        gutterColor.copy(alpha = ComposerSideGutterMaxAlpha)
                    )
                )
                val bottomGutterBrush = Brush.verticalGradient(
                    colors = listOf(
                        gutterColor.copy(alpha = 0f),
                        gutterColor.copy(alpha = ComposerBottomGutterMaxAlpha)
                    )
                )
                ...
                Box(
                    modifier = Modifier
                        ...
                        .width(ComposerHorizontalPadding)
                        .fillMaxHeight()
                        .drawBehind { drawRect(brush = sideGutterBrush) }
                )
