...
internal data class BackendNpuAttachProbeReportRequest(
    ...
    val engineConfigVariant: String = "default",
    val engineConfigCacheDir: String = "null",
    val engineConfigMaxNumTokens: String = "null",
    val engineConfigMaxNumImages: String = "null",
    val modelCanonicalPath: String = "-",
    val modelPathVariant: String = "-",
    val nativeLibraryDirVariant: String = "-",
    val applicationInfoNativeLibraryDir: String = "-",
    val contextApplicationInfoNativeLibraryDir: String = "-",
    val hardResolvedNativeLibraryDir: String = "-",
)
...
internal object BackendNpuAttachProbeReportFormatter {
    ...
    private fun buildRows(
        ...
        return listOf(
            ...
            "model_canonical_path" to request.modelCanonicalPath,
            "model_path_variant" to request.modelPathVariant,
            ...
            "native_library_dir_variant" to request.nativeLibraryDirVariant,
            "application_info_native_library_dir" to request.applicationInfoNativeLibraryDir,
            "context_application_info_native_library_dir" to request.contextApplicationInfoNativeLibraryDir,
            "hard_resolved_native_library_dir" to request.hardResolvedNativeLibraryDir,
            ...
            "engine_config_variant" to request.engineConfigVariant.orUnknown(),
            "engineconfig_cache_dir" to request.engineConfigCacheDir,
            "engineconfig_max_num_tokens" to request.engineConfigMaxNumTokens,
            "engineconfig_max_num_images" to request.engineConfigMaxNumImages,
