...
internal object Qairt244NativeResultParser {
    ...
    private val outputTerminatorKeys = setOf(
        ...
        "native_call_started_at_elapsed_realtime_ms",
        "native_call_finished_at_elapsed_realtime_ms",
        "native_call_duration_ms",
        "native_call_reached",
        "native_call_returned",
        "native_decode_started",
        "native_decode_finished",
        "native_cleanup_started",
        "native_cleanup_finished",
        "native_cleanup_reached",
        "native_session_destroy_started",
        "native_session_destroy_finished",
        "native_session_destroy_reached",
        "native_result_available",
        "native_result_tail",
        "native_diag_available",
        "native_diag_tail",
        "native_error_class",
